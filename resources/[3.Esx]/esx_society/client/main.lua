local eventName <const> = {
        ['job'] = {
            set = 'esx_society:setJob',
            get = 'esx_society:getJob',
            label = 'esx_society:setJobLabel',
            salary = 'esx_society:setJobSalary',
        },

        ['job2'] = {
            set = 'esx_society:setJob2',
            get = 'esx_society:getJob2',
            label = 'esx_society:setJob2Label',
            salary = 'esx_society:setJob2Salary',
        }
    }
