...
return {
	General = {
		...
		blip = {
			...
			{ name = 'drpepper', price = 2 },
			{ name = 'nestea', price = 2 },
			{ name = 'pepsi', price = 2 },
			{ name = 'sprite', price = 2 },
			{ name = '7up', price = 2 },
			{ name = 'apple_juice', price = 3 },
			{ name = 'arizona_punch', price = 2 },
			{ name = 'aw', price = 2 },
			{ name = 'big_blue', price = 3 },
			{ name = 'big_red', price = 3 },
			{ name = 'brisk_pink', price = 2 },
			{ name = 'canada_dry', price = 2 },
			{ name = 'capri_sun', price = 2 },
			{ name = 'cheetos', price = 2 },
			{ name = 'cheetos_hot', price = 3 },
			{ name = 'doritos_cr', price = 3 },
			{ name = 'doritos_nc', price = 3 },
			{ name = 'lays', price = 3 },
			{ name = 'lays_baked', price = 3 },
			{ name = 'sunchips', price = 2 },
			{ name = 'goldfish', price = 2 },
			{ name = 'honeybun', price = 3 },
            { name = 'cheez_its', price = 3 },
            { name = 'chips_ahoy', price = 3 },
            { name = 'cup_of_noodles', price = 5 },
            { name = 'fritos', price = 3 },
            { name = 'fruit_snacks', price = 2 },
            { name = 'funyuns', price = 3 },
            { name = 'gushers', price = 3 },
		}, locations = {
